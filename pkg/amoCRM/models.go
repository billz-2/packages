...
type Lead struct {
	...
	LossReasonID       any               `json:"loss_reason_id"` // null = any
	...
	ClosestTaskAt      any               `json:"closest_task_at"`
	IsDeleted          bool              `json:"is_deleted"`
	CustomFieldsValues []LeadCustomField `json:"custom_fields_values"` // optional: can be refined if needed
...
type LeadUpdate struct {
	...
	CustomFields   []LeadCustomField `json:"custom_fields_values,omitempty"` // You can define a struct for custom fields if needed
...
type LeadCustomField struct {
	...
	Values  []LeadCustomFieldValue `json:"values"`
}
